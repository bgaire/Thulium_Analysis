path_root = 'C:\Users\cparker60/Documents/Binod_Shared/2018 Thulium Experiment/May 2018 Data/';

master_bg = process_bg([path_root '20180524/fluorescence_signal.csv']);

[exc_lambdas, specs] = process_pattern(path_root, 'ablationData_*nm.csv','ablationData_%*d_%*d%*cM_%d');
...
set(gcf,'PaperUnits','inches');
print('-dpng', '20180530_2D_spec.png');